...
The results support our hypothesis that max pooling layer can be harmful to CNN by ignoring the position of features.
...
Compared to the state-of-the-art models, CNN-LSTM (Glove Amazon) outperforms Constituency Tree-LSTM Ensemble~\cite{LooksHHN17} on the binary setting and 2-channel CNN-Tree-LSTM is comparable with Byte mLSTM~\cite{mlstm} on the fine-grained setting.
