...
Step 2 and 3 help us to mitigate this problem.
...
In short, Glove Amazon is good for models on binary setting but can be harmful to them in fine-grained setting.
...
We think this is the reason why Glove Amazon is beneficial for classifying positive and negative sentiments in binary setting but harmful to detecting neutral in fine-grained setting. 
