...
With two input channels using both Glove Amazon and the standard Glove, 2-channel CNN-Tree-LSTM outperforms 2-channel CNN-LSTM on both binary and fine-grained setting.
